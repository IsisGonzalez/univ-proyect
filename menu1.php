...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="estilos_menu1.css">
      ...
      <article>
        <div class="content">
          <center>
            ...
            <tr>
              <td></td>
              <td><a href="registro_de_jugador.php"><input class="botton" type = "submit" value="JUGADOR" /></a></td>
            </tr>
            <tr>
              <td></td>
              <td><a href="registro_de_entrenador.php"><input class="botton"  type = "submit" value="ENTRENADOR" /></a></td>
            </tr>
            <tr>
              <td></td>
              <td><a href="registro_de_arbitro.php"><input class="botton" type = "submit" value="ARBITRO" /></a> </td>
            </tr>
          </center>
        </div>
      </article>
