...
<body>
   <section>
      ...
      <article>
         <div class="content">
            <form action = "validacion_entrenador.php" method="POST">
               </center>  
      
                  <h3> Registro de Entrenador </h3>
                  ...
                  <tr>
                     <td> * Edad </td>
                     <td><input type = "number" size="10" maxlength="10" placeholder="Ej.: 13" name = "edad"  required id="miCampo2" value="1"></td>
                  </tr>
                  <br></br>
