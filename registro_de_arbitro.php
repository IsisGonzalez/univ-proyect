...
<head>
   ...
   <link rel="stylesheet" type="text/php" href="validacion_arbitro.php">
...
<body>
   <section>
       ...
       <article>
         <div class="content">
            <form action = "validacion_arbitro.php" method="POST" >
               </center>        
               
                  <?php if(@$_GET['listo'] == "agregado") : ?>
                  
                  <p>Arbitro Agregado Exitosamente </p>
                  
                  <?php endif; ?>
                  
                  <h3> Registro de Arbitro </h3>
                  ...
                  <tr>
                     <td> * Apellido: </td>
                     <td><input type = "text" size="3" maxlength="30" placeholder="Ej.: Peralta" name = "apellido" id="miCampo3" required></td>
                  </tr>
                  <br></br>
                  ...
                  <tr>
                     <td> * Años de Experiencias: </td>
                     <td><input type = "number" size="3" min:"0" max="60" placeholder="Años de Experiencias" name = "aoe" id="miCampo2" required></td>
                  </tr>
                  <br></br>
